...
-- AddForeignKey
ALTER TABLE `cad_image` ADD CONSTRAINT `cad_image_service_id_fkey` FOREIGN KEY (`service_id`) REFERENCES `cad_service_car`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
